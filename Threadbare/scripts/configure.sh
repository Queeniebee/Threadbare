...
sudo cp scripts/threadbare.sh /etc/init.d/threadbare
sudo chmod 755 /etc/init.d/threadbare
sudo update-rc.d threadbare defaults
...
# sudo NODE_ENV=production nodemon threadbare.js
sudo /etc/init.d/threadbare restart