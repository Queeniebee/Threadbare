#!/bin/sh
# /etc/init.d/threadbare
# starts up ap0 and mesh0, bat0 interfaces
# starts up hostapd => broadcasting wireless network THREADBARE
# starts up node app

#TODO move app to /usr/bin/
DAEMON_PATH="/home/pi/www/threadbare"

DAEMON=sudo
DAEMONOPTS="NODE_ENV=production nodemon threadbare.js"

NAME=threadbare
DESC="Runs /home/pi/www/threadbare/threadbare.js in production mode with nodemon"
